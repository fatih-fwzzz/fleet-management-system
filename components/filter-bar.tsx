/**
 * Filter Bar Component — multi-select route/trip/direction filter chips.
 * Sits at the top of the dashboard, same page as the vehicle list.
 */
...
export function FilterBar() {
  ...
  // Deduplicate trips by headsign for cleaner UX
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      {/* Trip Filter — only shown when routes are selected */}
